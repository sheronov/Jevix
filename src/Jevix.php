...
class Jevix
{
    ...
    /**
     * CONFIGURATION: Adding autoadd attributes and their values to tag. If the 'rewrite' set as true, the attribute
            ...
            if ($aProtocols) {
                if ($bClearDefault || !isset($this->allowedProtocols[$sParam])) {
                    ...
                    $this->allowedProtocols[$sParam] = implode(':|',
                            array_merge($this->allowedProtocolsDefault, $aProtocols)) . ':';
                }
            }
